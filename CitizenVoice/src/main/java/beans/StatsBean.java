...
public class StatsBean implements Serializable {
    ...
    //int pid=12;
    int qid;
    Collection<StatsData> sdata;
    GenericType<Collection<StatsData>> gsdata;
    ...
    public Collection<StatsData> getSdata() {
        ...
        if((qid!=0) && (pid>0)){
        sdata= ac.getStats(Response.class, String.valueOf(qid), level, String.valueOf(pid)).readEntity(gsdata);
        if(count==1){
...
//        
     ...
     public void createBarModel2() {
      ...
      System.out.println("In create chart");
       ...
       Collection<StatsData> mdata= ac.getStats(Response.class, String.valueOf(qid), level, String.valueOf(pid)).readEntity(gsdata);
...
//        labels.add(s.getLevelName());
  ...
  public void itemSelect(ItemSelectEvent event) {
    ...
    public StatsBean() {
        ac = new AdminClient();
        sdata= new ArrayList<>();
        gsdata = new GenericType<Collection<StatsData>>(){};
    }
