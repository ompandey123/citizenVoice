...
public class AdminResource {
   ...
   @Path("getAllStates")
    ...
    @Path("addQuestion/{category_id}/{question}/{level}/{option1}/{option2}/{option3}/{option4}")
    public void addQuestion(@PathParam("category_id") int categoryid, @PathParam("question") String question, @PathParam("level") String level, @PathParam("option1") String option1, @PathParam("option2") String option2, @PathParam("option3") String option3, @PathParam("option4") String option4,  PackedObjects p) {
        al.addQuestion(categoryid, question, level, option1, option2, option3, option4, p);
    }

    @RolesAllowed("admin")
    @POST
    @Path("updateQuestion/{qid}/{category_id}/{question}/{level}/{option1}/{option2}/{option3}/{option4}")
